            ...
            : Container(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.of(context).pushReplacementNamed("/podpahs");
                      },
                      onHover: (value) {
                        setState(() {
                          onHoverList[3] = value;
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.of(context).pushReplacementNamed("/partners");
                      },
                      onHover: (value) {
                        setState(() {
                          onHoverList[4] = value;
                      ...
                      child: Container(
                        margin: EdgeInsets.only(
                            right: Responsive.isSmallScreen(context) ? 20 : 40),
                        child: Text(
                          "Patrocinadores",
                          style: TextStyle(
                            color: !onHoverList[4]
            ...
            child: Wrap(
              ...
              children: [
                ...
                InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  child: Container(
                    margin: const EdgeInsets.only(left: 20, top: 10, right: 30),
                    child: Row(
                      children: [
                        Text(
                          "Login",
